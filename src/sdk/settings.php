<?php
define('C_REST_CLIENT_ID','local.646dda17bc2ef2.04106638');//Application ID
define('C_REST_CLIENT_SECRET','pGtN8vKY1cbBIr6NW8h9o5gCtZsNHj63RQDuhipmYTpsMeJImb');//Application key
// or
